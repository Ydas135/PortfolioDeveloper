                    ...
                    {Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
                      ...
                      return Icon ? (
                        <a
                          ...
                          className="group relative p-4 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 hover:border-primary/50 hover:scale-110 transition duration-300"
          ...
          <div className="pt-8 border-t border-white/10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <p className="text-white/50 text-sm">
                x {new Date().getFullYear()} {PERSONAL_INFO.name}. All rights reserverd 
              </p>
