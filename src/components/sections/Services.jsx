  ...
  return (
    <section id='services' className='relative py-20 bg-black overflow-hidden'>
        <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 w-96 h-96 -translate-x-1/2 -translate-y-1/2 bg-primary/10 opacity-20 rounded-full blur-3xl" />
        </div>
            ...
            <FadeIn delay={0} >
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-white/60 max-w-xl mx-auto">
                        Comprehensive solutions to transform your ides into excepctional digital experiences.
                    </p>
                </div>
            </FadeIn>
