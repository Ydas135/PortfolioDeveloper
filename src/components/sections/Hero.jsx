            ...
            <FadeIn delay={0}>
              ...
              <FadeIn delay={200}>
                <p className="text-lg text-white/70 max-w-[550px] mb-8">
                  Building modern, scalable web application with React, javaScript and cutting-edge technologies. Transforming ideas into exceptional digital experiences.
                </p>
              </FadeIn>
              <FadeIn delay={300}>
                <button
              ...
              <FadeIn delay={400}>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-10 max-w-full">
                  {STATS.map((stat, index) => (
                    ...
                    >
                      <div className="text-2xl font-normal text-primary mb-[18px] font-mono">
                        {stat.value}
                      </div>
            ...
            <div className="relative">
              <div className="relative overflow-hidden rounded-2xl aspect-4/5 max-w-[500px] ml-auto group">
                <div className="absolute inset-0 rounded-2xl overflow-hidden">
                  <div className="absolute inset-[-2px] bg-linear-to-r from-primary via-primary/10 to-primary animate-spin-slow rounded-2xl"></div>
                </div>
                {/**Image Container */}
