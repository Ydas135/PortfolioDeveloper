            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                ...
                <div className="flex flex-col gap-12">
                    <div className="flex flex-col gap-8">
                        <FadeIn delay={60}>
                            <div className="inline-flex items-center gap-2.5 py-2.5 border border-primary/30 bg-primary/10 rounded-full w-fit">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-white/70 leading-relaxed">
                                            Specialized in building scalable web applications with modern tecnologies and best practices.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                                ...
                                <h3 className="text-base font-semibold text-white mb-2">Clear Code</h3>
                                <p className="text-sm text-white/70 leading-relaxed">
                                    Writing maintable, well-documented code that scales.
                                </p>
                            </div>
                        </div>
