            ...
            <FadeIn delay={100}>
                <div className="flex flex-wrap justify-center gap-3 mb-16">
                    {categories.map((category) => (
                        <button 
                            className={`group relative px-6 py-3 rounded-full font-medium transition-all duration-300 ${activateCategory === category ? 'text-white' : 'text-white/60 hover:text-white'}`}
